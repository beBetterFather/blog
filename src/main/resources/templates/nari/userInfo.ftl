                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if(data.state=='success'){
                                ...
                                $("#workDate").val(dateFormat(data.twork.workDate));
                                $("#startTime").val(dateTimeFormat(data.twork.startTime));
                                $("#endTime").val(dateTimeFormat(data.twork.endTime));
                               /* $("#taxi").val(data.twork.taxi);*/
                               /* $("[name=]").each(function(i, item){
                                ...
                                $('[name=taxi]').each(function(i,item){
                                    if($(item).val()==data.twork.taxi){
                                ...
                                $("#remarks").val(data.twork.remarks);
    ...
    <form class="layui-form" action="" id="addeditformid">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <#--<input type="text" id="workDate" name="workDate" lay-verify="userName" autocomplete="off" placeholder="请输入日期" class="layui-input">-->
                <input type="text" class="layui-input" id="workDate" name="workDate" placeholder="yyyy-MM-dd">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">开始时间</label>
            <div class="layui-input-block">
            <#--<input type="text" id="startTime" name="startTime" lay-verify="password" autocomplete="off" placeholder="请输入开始时间" class="layui-input">-->
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">是否打车</label>
            <div class="layui-input-block">
                <#--<input type="text" id="car" name="car" autocomplete="off" placeholder="请输入是否打车" class="layui-input">-->
                <input type="radio" name="taxi" title="未打车" value="0"  checked="checked">
                <input type="radio" name="taxi" title="打车" value="1" >
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">备注信息</label>
            <div class="layui-input-block">
                <input type="text" id="remarks" name="remarks" autocomplete="off" placeholder="请输入备注信息" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
